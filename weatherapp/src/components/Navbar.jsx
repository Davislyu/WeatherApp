...
const Navbar = () => {
  ...
  return (
    <nav className="navbar absolute top-0 left-0 right-0 w-full h-fit bg-transparent backdrop-blur-lg flex  flex-col sm:flex-row  items-center justify-between gap-2  z-10 ">
